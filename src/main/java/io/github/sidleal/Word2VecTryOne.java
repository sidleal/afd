...
public class Word2VecTryOne {

    private static final Logger log = LoggerFactory.getLogger(Word2VecTryOne.class);
    ...
    public static void main2(String... args ) throws Exception {
        ...
        paragraphVectors.lookupTable().plotVocab(tsne, 50, new File("plot.txt"));
    }
    ...
    public static void main( String... args ) throws Exception {
        ...
        WordVectorSerializer.writeWordVectors(paragraphVectors, "words.txt");
