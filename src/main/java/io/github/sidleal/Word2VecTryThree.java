...
public class Word2VecTryThree {

    private static final Logger log = LoggerFactory.getLogger(Word2VecTryThree.class);
    ...
    public static String run() throws Exception {
        ...
        LabelAwareIterator iterator = new JSONLabelIterator(listaTreino);
        ...
        */
        LabelAwareIterator unlabeledIterator = new JSONLabelIterator(listaTeste);
        ...
        */
        ...
        while (unlabeledIterator.hasNextDocument()) {
            ...
            if (documentAsCentroid != null) {
                ...
                int avg = (Integer.valueOf(scores.get(0).getFirst()) + Integer.valueOf(scores.get(1).getFirst()) + Integer.valueOf(scores.get(2).getFirst())) / 3;
                log.info("        avg : " + avg);

                ret += document.getLabel() + " --> " + avg + "\n";
            }
        }
        return ret;
    }
